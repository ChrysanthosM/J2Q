...
import j2sql.core.sqlCreator.sqlResolvers.sqlFunctions.SQLFunction;
...
final class SQLRetrieverForDB_SQLite extends SQLRetrieverForDBs {
    ...
    public String getSQLStatementForSelect() {
        ...
        returnStmt.append(super.getWorkBuildSQLSelectFields().getStringForSQL())
                .append(super.getWorkBuildSQLJoinWith().getSelectedJoinFieldsForSQL()).append(StringUtils.SPACE);
        returnStmt.append(super.getSQLStatementFromWhereGroupByOrderBy()).append(StringUtils.SPACE);
        returnStmt.append(getLimitOffsetForSQL(super.getWorkLInSQLBuilderParams().getLimitOffset())).append(StringUtils.SPACE);
