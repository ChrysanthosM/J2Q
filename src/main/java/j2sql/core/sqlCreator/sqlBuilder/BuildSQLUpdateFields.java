...
public final class BuildSQLUpdateFields extends BuildSQLCore {

    public static BuildSQLUpdateFields createFor(SQLRetrieverForDBs forSQLRetrieverForDB) { return new BuildSQLUpdateFields(forSQLRetrieverForDB); }
