...
import j2q.setup.definition.design.schema.sqlite.enums.DbFValues;
import j2q.setup.definition.design.schema.sqlite.table.TAutoNumbering;
import j2q.setup.definition.design.schema.sqlite.table.TOptions;
...
import static j2q.core.J2SQL.asAlias;
import static j2q.core.J2SQL.operation;
import static j2q.core.J2SQLShared.*;
import static j2q.core.J2SQLShared.PFX.*;


@SpringBootTest(properties = {"datasource.type=sqlite"})
public class testSQLStatementsSQLIte {
    ...
    private String checkResult(String stmt, String shouldBe) {
        String checkTest = StringUtils.trimToEmpty(shouldBe.replaceAll("\\s+", StringUtils.SPACE).replaceAll("\\s+,", ","));
    ...
    private void testSQLStatementsMain(boolean normalizeNames) {
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).setApplyAutoAlias().insertInto(tAutoNumbering).insertRow("AAA", 1)
                        .getSQL(),
                normalizeNames
                        ? "INSERT INTO AUTO_NUMBERING (EntityType, EntityNumber) VALUES ('AAA', 1)"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).insertInto(tAutoNumbering).insertRows(List.of("AAA", 1), List.of("BBB", 2), List.of("CCC", 3))
                        .getSQL(),
                normalizeNames
                        ? "INSERT INTO AUTO_NUMBERING (EntityType, EntityNumber) VALUES ('AAA', 1), ('BBB', 2), ('CCC', 3)"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).insertInto(tAutoNumbering).insertRowsFrom(
                        ...
                        .getSQL(),
                normalizeNames
                        ? "INSERT INTO AUTO_NUMBERING SELECT RecID, EntityType, EntityNumber FROM AUTO_NUMBERING  WHERE (EntityNumber = 1)"
                        : "INSERT INTO Sys_AutoNumbering SELECT Sys_RecID, Sys_EntityType, Sys_EntityNumber FROM Sys_AutoNumbering  WHERE (Sys_EntityNumber = 1)"));
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering).distinct().setApplyAutoAlias()
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT DISTINCT RecID AS \"Rec_ID\", EntityType AS \"Entity_Type\", EntityNumber AS \"Entity_Number\" FROM AUTO_NUMBERING  WHERE (EntityType = '1')"
                        : "SELECT DISTINCT Sys_RecID AS \"Rec_ID\", Sys_EntityType AS \"Entity_Type\", Sys_EntityNumber AS \"Entity_Number\" FROM Sys_AutoNumbering  WHERE (Sys_EntityType = '1')"));
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering).select(tAutoNumbering.ENTITY_TYPE, tAutoNumbering.ENTITY_NUMBER, operation(tAutoNumbering.ENTITY_NUMBER, "+1")).setApplyAutoAlias()
                        .getSQL(),
                normalizeNames
                        ? "SELECT EntityType AS \"Entity_Type\", EntityNumber AS \"Entity_Number\", EntityNumber  +1 FROM AUTO_NUMBERING"
                        : "SELECT Sys_EntityType AS \"Entity_Type\", Sys_EntityNumber AS \"Entity_Number\", Sys_EntityNumber  +1 FROM Sys_AutoNumbering"));
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering).select(tAutoNumbering.ENTITY_TYPE.as("asTheAlias"))
                        .getSQL(),
                normalizeNames
                        ? "SELECT EntityType AS \"asTheAlias\" FROM AUTO_NUMBERING"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).deleteFrom(tAutoNumbering).where(tAutoNumbering.ENTITY_NUMBER.eq(1))
                        .getSQL(),
                normalizeNames
                        ? "DELETE FROM AUTO_NUMBERING WHERE (EntityNumber = 1)"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering.as(T0))
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT T0.RecID AS \"Rec_ID\", T0.EntityType AS \"Entity_Type\", T0.EntityNumber AS \"Entity_Number\" FROM AUTO_NUMBERING AS T0  " +
                        "WHERE EXISTS (SELECT A1.* FROM OPTIONS AS A1  WHERE (T0.EntityType = A1.OptionType))"
                        : "SELECT T0.Sys_RecID AS \"Rec_ID\", T0.Sys_EntityType AS \"Entity_Type\", T0.Sys_EntityNumber AS \"Entity_Number\" FROM Sys_AutoNumbering AS T0  " +
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames)
                ...
                normalizeNames
                        ...
                        "FROM AUTO_NUMBERING"
                        : "SELECT Sys_EntityType AS \"Entity_Type\", Sys_EntityNumber AS \"asAlias\", 'const1', '2', '4.5', '5' AS \"asAlias5\", " +
                        "CONCAT(CONCAT(CONCAT(Sys_EntityType AS \"Entity_Type\", 'AAA'), '1'), " +
                        "LTRIM(Sys_EntityType AS \"Entity_Type\")) " +
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames)
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT (MIN(T.EntityType) AS \"functionAsAlias\") FROM AUTO_NUMBERING AS T   ORDER BY T.EntityType ASC  LIMIT 1 OFFSET 2"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering)
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT EntityType AS \"Entity_Type\", COUNT(*) FROM AUTO_NUMBERING  GROUP BY EntityType  HAVING COUNT(*) > 1 ORDER BY EntityType DESC, EntityNumber ASC"
                        : "SELECT Sys_EntityType AS \"Entity_Type\", COUNT(*) FROM Sys_AutoNumbering  GROUP BY Sys_EntityType  HAVING COUNT(*) > 1 ORDER BY Sys_EntityType DESC, Sys_EntityNumber ASC"));
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering.as(T0)).selectAll()
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT T0.*, J1.* FROM AUTO_NUMBERING AS T0 LEFT JOIN OPTIONS AS J1 ON (J1.EntityType = T0.OptionType)"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering.as(T0))
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT T0.RecID AS \"Rec_ID\", T0.EntityType AS \"Entity_Type\", T0.EntityNumber AS \"Entity_Number\", J1.RecID AS \"Rec_ID\", J1.OptionType AS \"Option_Type\", J1.OptionName AS \"Option_Name\", J1.OptionValue AS \"Option_Value\", J1.OptionDetails AS \"Option_Details\" FROM AUTO_NUMBERING AS T0 LEFT JOIN OPTIONS AS J1 ON (J1.EntityType = T0.OptionType)"
                        : "SELECT T0.Sys_RecID AS \"Rec_ID\", T0.Sys_EntityType AS \"Entity_Type\", T0.Sys_EntityNumber AS \"Entity_Number\", J1.Sys_RecID AS \"Rec_ID\", J1.Sys_OptionType AS \"Option_Type\", J1.Sys_OptionName AS \"Option_Name\", J1.Sys_OptionValue AS \"Option_Value\", J1.Sys_OptionDetails AS \"Option_Details\" FROM Sys_AutoNumbering AS T0 LEFT JOIN Sys_Options AS J1 ON (J1.Sys_EntityType = T0.Sys_OptionType)"));
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering.as(T0)).select(tAutoNumbering.ALL)
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT T0.*, J1.* FROM AUTO_NUMBERING AS T0 LEFT JOIN OPTIONS AS J1 ON (J1.EntityType = T0.OptionType) WHERE (J1.OptionType > '1' AND J1.OptionType < '1000')"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering).where(tAutoNumbering.ENTITY_TYPE.eq("?")).setApplyAutoAlias()
                        .getSQL(),
                normalizeNames
                        ? "SELECT RecID AS \"Rec_ID\", EntityType AS \"Entity_Type\", EntityNumber AS \"Entity_Number\" FROM AUTO_NUMBERING  WHERE (EntityType = ?)"
                        : "SELECT Sys_RecID AS \"Rec_ID\", Sys_EntityType AS \"Entity_Type\", Sys_EntityNumber AS \"Entity_Number\" FROM Sys_AutoNumbering  WHERE (Sys_EntityType = ?)"));
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering).select(tAutoNumbering.ENTITY_TYPE)
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT EntityType AS \"Entity_Type\" FROM AUTO_NUMBERING     " +
                        "UNION SELECT EntityType AS \"Entity_Type\" FROM AUTO_NUMBERING      " +
                        "UNION SELECT EntityType AS \"Entity_Type\" FROM AUTO_NUMBERING"
                        : "SELECT Sys_EntityType AS \"Entity_Type\" FROM Sys_AutoNumbering     " +
                        "UNION SELECT Sys_EntityType AS \"Entity_Type\" FROM Sys_AutoNumbering      " +
                        "UNION SELECT Sys_EntityType AS \"Entity_Type\" FROM Sys_AutoNumbering"));
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).distinct().from(tAutoNumbering).where(tAutoNumbering.ENTITY_NUMBER.eq(1)).setApplyAutoAlias()
                        .getSQL(),
                normalizeNames
                        ? "SELECT DISTINCT RecID AS \"Rec_ID\", EntityType AS \"Entity_Type\", EntityNumber AS \"Entity_Number\" FROM AUTO_NUMBERING  WHERE (EntityNumber = 1)"
                        : "SELECT DISTINCT Sys_RecID AS \"Rec_ID\", Sys_EntityType AS \"Entity_Type\", Sys_EntityNumber AS \"Entity_Number\" FROM Sys_AutoNumbering  WHERE (Sys_EntityNumber = 1)"));
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering)
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT RecID AS \"Rec_ID\", EntityType AS \"Entity_Type\", EntityNumber AS \"Entity_Number\" FROM AUTO_NUMBERING  " +
                        "WHERE (EntityType = 'E02') " +
                        "AND (EntityType IN (SELECT EntityType FROM AUTO_NUMBERING)) " +
                        ...
                        : "SELECT Sys_RecID AS \"Rec_ID\", Sys_EntityType AS \"Entity_Type\", Sys_EntityNumber AS \"Entity_Number\" FROM Sys_AutoNumbering  " +
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames)
                        ...
                        .getSQL(),
                normalizeNames
                        ? "SELECT T0.EntityNumber AS \"asEntNum\" FROM AUTO_NUMBERING AS T0  " +
                        "WHERE (T0.EntityNumber > 1) " +
                        "AND NOT (T0.EntityType LIKE 'Α%') " +
                        "AND (T0.EntityType NOT LIKE 'B%') " +
                        "AND (T0.EntityNumber BETWEEN 2 AND 2000) " +
                        "AND (T0.EntityType IN (SELECT EntityType FROM AUTO_NUMBERING)) " +
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).from(tAutoNumbering)
                ...
                normalizeNames
                        ...
                        : "SELECT CASE  " +
                            ...
                            "ELSE 11 END, " +
                        "CASE Sys_EntityType AS \"Entity_Type\" " +
                            "WHEN '2' THEN '22' " +
                            "WHEN '3' THEN '33' " +
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).updateInto(tAutoNumbering).updateFieldSetValue(tAutoNumbering.ENTITY_NUMBER, tOptions.OPTION_VALUE)
                        .getSQL(),
                normalizeNames
                        ? "UPDATE AUTO_NUMBERING SET EntityNumber = OptionValue"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).updateInto(tAutoNumbering).updateFieldSetValue(tAutoNumbering.ENTITY_NUMBER, 1)
                        .getSQL(),
                normalizeNames
                        ? "UPDATE AUTO_NUMBERING SET EntityNumber = 1"
        ...
        stmts.add(checkResult(J2SQL.create(workDataSource, normalizeNames).updateInto(tAutoNumbering).updateFieldSetValue(tAutoNumbering.ENTITY_NUMBER, operation(tAutoNumbering.ENTITY_NUMBER, "+1"))
                        .getSQL(),
                normalizeNames
                        ? "UPDATE AUTO_NUMBERING SET EntityNumber = EntityNumber  +1"
